...
public class MainActivity extends AppCompatActivity implements CategoryRVAdapter.CategoryClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView newsRV = findViewById(R.id.idRV_News);
    ...
    private void getNews(String category){
        ...
        String url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=df606e2cb8384d5f93a967dcad590aa9";
        ...
        call.enqueue(new Callback<NewsModel>() {
            ...
            public void onFailure(@NonNull Call<NewsModel> call, @NonNull Throwable t) {
                Toast.makeText(MainActivity.this, "Failed to Get "+category+" News ", Toast.LENGTH_SHORT).show();
            }
        });
    }
